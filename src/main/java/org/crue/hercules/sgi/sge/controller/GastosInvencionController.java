...
/**
 * GastosInvencionController
 */
@RestController
@RequestMapping(GastosInvencionController.REQUEST_MAPPING)
@RequiredArgsConstructor
@Slf4j
public class GastosInvencionController {

  public static final String PATH_DELIMITER = "/";
  public static final String REQUEST_MAPPING = PATH_DELIMITER + "gastos-invencion";
  ...
  public static final String TIPO_OPERACION_PII_GASTOS = "GAS";
  ...
  public DatoEconomicoDetalleOutput findById(@PathVariable String invencionId) {
    log.debug("findById({}, {}) - start", invencionId, TIPO_OPERACION_PII_GASTOS);
    DatoEconomicoDetalleOutput datoEconomico = service.findById(invencionId, TIPO_OPERACION_PII_GASTOS);
    log.debug("findById({}, {}) - end", invencionId, TIPO_OPERACION_PII_GASTOS);
  ...
  public ResponseEntity<List<DatoEconomicoColumnaPiiDto>> findAllColumnas(
    ...
    List<DatoEconomicoColumnaPiiDto> columnas = service.findAllColumnasPii(query, TIPO_OPERACION_PII_GASTOS, paging);
