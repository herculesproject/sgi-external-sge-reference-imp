...
@Entity
@Data
@Table(name = PartidaPresupuestariaGasto.TABLE_NAME)
@EqualsAndHashCode(callSuper = false)
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class PartidaPresupuestariaGasto extends BaseEntity {

  protected static final String TABLE_NAME = "partida_presupuestaria_gasto";
